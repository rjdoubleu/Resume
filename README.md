...
+ Lead satellite characterization undergraduate research team
	...
	- Published primary author and presenter of the paper accepted into AMOSTech 2020
...
+ Accepted invitation to membership in the CUI government research group (contact me directly for details)
+ Cloud: Amazon Web Services (AWS)
...
+ Big Data Programming (Grade: A)
	...
	- Developed a serverless website using AWS (CloudFront, API Gateway, Lambda, IAM, S3)
